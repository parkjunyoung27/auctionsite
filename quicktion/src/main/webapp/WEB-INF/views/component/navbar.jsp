...
<div class ="navbar">
	...
	<ul id ="menu">
		...
		<li class="menuli"><a href="./board.do?board_cate_no=1">Board</a>
				<ul class="son">
					<li><a href="./board.do?board_cate_no=1">공지사항</a></li>
					<li><a href="./board.do?board_cate_no=2">가맹점주</a></li>
					<li><a Href="./board.do?board_cate_no=3">문의사항</a></li>
				</ul>
		</li>
		<li class="menuli">
			<c:choose>
